    ...
    <form id="loginForm">
      ...
      <div class="mb-3">
        ...
        <div class="position-relative">
          ...
          <input type="email" class="form-control form-control-pp ps-5" id="email" name="email" autocomplete="username" placeholder="coordinator@pesiams.edu.in" value="coordinator@pesiams.edu.in" required>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="position-relative">
          ...
          <input type="password" class="form-control form-control-pp ps-5 pe-5" id="password" name="password" autocomplete="current-password" placeholder="••••••••••••" value="Coordinator@2026" required>
