...
<!-- SweetAlert2 for beautiful popups with local fallback -->
<script src="assets/vendor/sweetalert2/sweetalert2.all.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11" onerror="this.onerror=null;"></script>
        ...
        <form id="postJobForm">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control form-control-pp" id="jobCompName" name="company_name" autocomplete="organization" placeholder="e.g. Wipro" required>
            </div>
            <div class="col-md-6">
              <label for="jobRole" class="form-label font-weight-600 text-muted small">ROLE / POSITION</label>
              <input type="text" class="form-control form-control-pp" id="jobRole" name="role" autocomplete="organization-title" placeholder="e.g. Software Development Engineer" required>
            </div>
            <div class="col-md-6">
              <label for="jobPackage" class="form-label font-weight-600 text-muted small">PACKAGE (LPA)</label>
              <input type="number" step="0.01" class="form-control form-control-pp" id="jobPackage" name="package_lpa" autocomplete="off" placeholder="e.g. 14.5" required>
            </div>
            <div class="col-md-6">
              <label for="jobDate" class="form-label font-weight-600 text-muted small">DRIVE DATE (INTERVIEW DATE)</label>
              <input type="date" class="form-control form-control-pp" id="jobDate" name="drive_date" autocomplete="off" required>
            </div>
            <div class="col-md-4">
              <label for="jobMinCgpa" class="form-label font-weight-600 text-muted small">MINIMUM CGPA</label>
              <input type="number" step="0.1" min="0" max="10" class="form-control form-control-pp" id="jobMinCgpa" name="min_cgpa" value="6.0" autocomplete="off" required>
            </div>
            <div class="col-md-4">
              <label for="jobMaxBacklogs" class="form-label font-weight-600 text-muted small">MAX ALLOWED BACKLOGS</label>
              <input type="number" min="0" class="form-control form-control-pp" id="jobMaxBacklogs" name="max_backlogs" value="0" autocomplete="off" required>
            </div>
            <div class="col-md-4">
              <label for="jobDeadline" class="form-label font-weight-600 text-muted small">REGISTRATION DEADLINE</label>
              <input type="date" class="form-control form-control-pp" id="jobDeadline" name="registration_deadline" autocomplete="off" required>
            </div>
